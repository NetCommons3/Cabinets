 ...
 */
	public $migration = array(
		'up' => array(
			...
			'create_field' => array(
				'cabinet_files' => array(
					'cabinet_id' => array('type' => 'integer', 'null' => false, 'default' => null, 'unsigned' => false, 'after' => 'id'),
					'filename' => array('type' => 'string', 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'title | タイトル |  | ', 'charset' => 'utf8', 'after' => 'language_id'),
					'description' => array('type' => 'text', 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'file body1 | 本文1 |  | ', 'charset' => 'utf8', 'after' => 'filename'),
					'is_folder' => array('type' => 'boolean', 'null' => false, 'default' => '0', 'after' => 'key'),
				),
				'cabinets' => array(
					'size' => array('type' => 'integer', 'null' => false, 'default' => '0', 'unsigned' => false, 'after' => 'modified'),
				),
			),
			'drop_field' => array(
				'cabinet_files' => array('cabinet_key', 'category_id', 'title', 'body1', 'body2', 'public_type', 'publish_start', 'publish_end', 'block_id'),
			),
		),
		'down' => array(
			'drop_table' => array(
			...
			'create_field' => array(
				'cabinet_files' => array(
					'cabinet_key' => array('type' => 'string', 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'charset' => 'utf8'),
					'category_id' => array('type' => 'integer', 'null' => false, 'default' => null, 'unsigned' => false, 'comment' => 'category id | カテゴリーID | cabinet_categories.id | '),
					'title' => array('type' => 'string', 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'title | タイトル |  | ', 'charset' => 'utf8'),
					'body1' => array('type' => 'text', 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'file body1 | 本文1 |  | ', 'charset' => 'utf8'),
					'body2' => array('type' => 'text', 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'file body2 | 本文2 |  | ', 'charset' => 'utf8'),
