 ...
 */
	public $migration = array(
		'up' => array(
			'create_field' => array(
				'cabinet_files' => array(
					'plus_vote_number' => array('type' => 'integer', 'null' => false, 'default' => '0', 'unsigned' => false, 'comment' => 'plus vote number | プラス投票数 |  | ', 'after' => 'description'),
			...
			'drop_field' => array(
				'cabinet_settings' => array('use_comment', 'use_comment_approval', 'use_like', 'use_unlike', 'use_sns'),
			),
			'drop_table' => array(
